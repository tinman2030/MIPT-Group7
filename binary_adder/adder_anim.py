...
class HalfAdder(Scene):
    def construct(self):
        ...
        self.play(
            ...
            GrowFromPoint(Line(carry_in.get_right(), carry_in.get_right() + [2.2,0,0], stroke_width = 1),carry_in.get_right()),
            GrowFromPoint(Line(carry_in.get_right() + [2.2,0,0], carry_in.get_right() + [2.2,1.5,0], stroke_width = 1),carry_in.get_right()),
            GrowFromPoint(Line(carry_in.get_right() + [2.2,1.5,0], box2.get_left() + [0,-0.25,0], stroke_width = 1),carry_in.get_right() + [2.2,1.5,0]),
            GrowFromPoint(Line(or_gate.get_right(), carry_label.get_left() + [0,-0,0], stroke_width = 1),or_gate.get_right()),

            GrowFromPoint(Line(box.get_right() + [0,-0.2,0], box.get_right() + [0.3,-0.2,0], stroke_width = 1),box.get_right() + [0,-0.2,0]),
            GrowFromPoint(Line(box.get_right() + [0.3,-0.2,0], or_gate.get_left() + [-2.46,-0.2,0], stroke_width = 1),box.get_right() + [0,-0.2,0]),
            GrowFromPoint(Line(or_gate.get_left() + [-2.46,-0.2,0], or_gate.get_left() + [0,-0.2,0], stroke_width = 1),box.get_right() + [-2.46,-0.2,0]),

            GrowFromPoint(Line(box2.get_right() + [0,-0.2,0], box2.get_right() + [0.3,-0.2,0], stroke_width = 1),box.get_right() + [0,-0.2,0]),
            GrowFromPoint(Line(box2.get_right() + [0.3,-0.2,0], box2.get_right() + [0.3,-1.8,0], stroke_width = 1),box.get_right() + [0.3,-0.2,0]),
            GrowFromPoint(Line(box2.get_right() + [0.3,-1.8,0], box2.get_right() + [0.75,-1.8,0], stroke_width = 1),box.get_right() + [0.75,-1.8,0]),
        ...
        self.play(
            ...
            GrowFromPoint(Line(input_A0.get_bottom(), box0.get_top(), color=WHITE, stroke_width=1),input_A0.get_bottom()),
            GrowFromPoint(Line(input_B0.get_bottom(), box0.get_top() + [0.37,0,0], color=WHITE, stroke_width=1),input_B0.get_bottom()),
            GrowFromPoint(Line(input_A1.get_bottom(), box1.get_top(), color=WHITE, stroke_width=1),input_A1.get_bottom()),
            GrowFromPoint(Line(input_B1.get_bottom(), box1.get_top() + [0.37,0,0], color=WHITE, stroke_width=1),input_B1.get_bottom()),
            GrowFromPoint(Line(input_A2.get_bottom(), box2.get_top(), color=WHITE, stroke_width=1),input_A2.get_bottom()),
            GrowFromPoint(Line(input_B2.get_bottom(), box2.get_top() + [0.37,0,0], color=WHITE, stroke_width=1),input_B2.get_bottom()),

            GrowFromPoint(Line(box0.get_bottom(), sum0.get_top(), color=WHITE, stroke_width=1),box0.get_bottom()),
            GrowFromPoint(Line(box1.get_bottom(), sum1.get_top(), color=WHITE, stroke_width=1),box1.get_bottom()),
            GrowFromPoint(Line(box2.get_bottom(), sum2.get_top(), color=WHITE, stroke_width=1),box2.get_bottom()),

            GrowFromPoint(Line(box0.get_left() + [0,-0.1,0], box1.get_right() + [0,-0.1,0], color=WHITE, stroke_width=1),box0.get_left() + [0,-0.1,0]),
            GrowFromPoint(Line(box1.get_left() + [0,-0.1,0], box2.get_right() + [0,-0.1,0], color=WHITE, stroke_width=1),box1.get_left() + [0,-0.1,0]),

            GrowFromPoint(Line(box2.get_left() + [0,-0.1,0], carry_out.get_top() + [0,0.9,0], color=WHITE, stroke_width=1),box1.get_left() + [0,-0.1,0]),
            GrowFromPoint(Line(carry_out.get_top(), carry_out.get_top() + [0,0.9,0], color=WHITE, stroke_width=1),carry_out.get_top()),
