    ...
    def createUnit(self,A,B,C_in,position):
        ...
        if(C_in == 1):
            ...
            if(position == 0):
                ...
                line_carry2 = Line(box.get_left() + [-0.486, -0.1, 0], c.get_top(), color = BLUE_C, stroke_width = 3)
            
                self.add(box, input_A, input_B, sum, c, line_A, line_B, line_sum, line_carry,line_carry2)
            else:
            ...
            if(position == 0):
                ...
                line_carry2 = Line(box.get_left() + [-0.486, -0.1, 0], c.get_top(), color = WHITE, stroke_width = 1)
